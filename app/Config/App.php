...
//$config['base_url'] = $base;
	//public $baseURL = 'http://localhost/process_flow/Back_end/back_end';
	...
	*/
	public $CSRFTokenName  = 'ABCDEFGHIJKLMNOPQRSTUVW@/#$%^&*()';
	public $CSRFCookieName = 'ATSJ-XRF';
	public $CSRFExpire     = 7200;
	public $CSRFRegenerate = true;
	public $CSRFRedirect   = false;
	public $CSRFHeaderName = 'ATSJ-XRF-TOKEN';
